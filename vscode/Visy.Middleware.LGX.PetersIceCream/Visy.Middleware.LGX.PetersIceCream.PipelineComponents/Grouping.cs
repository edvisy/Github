...
namespace Visy.Middleware.LGX.PetersIceCream.PipelineComponents
{
    [ComponentCategory("9d0e4101-4cce-4536-83fa-4a5040674ad6")]
    [Guid("2E1AF1F5-67F2-4BE1-B74D-E72983A581FB")]
    ...
    public class Grouping : IBaseComponent, IComponentUI, IPersistPropertyBag, IDisassemblerComponent
    {
        ...
        {
            classID = new Guid("2E1AF1F5-67F2-4BE1-B74D-E72983A581FB");
        }
        ...
        public void Disassemble(IPipelineContext pContext, IBaseMessage pInMsg)
        {
            ...
            try
            {
                ...
                XmlNode xmlNode = !string.IsNullOrEmpty(strHeaderElement) ? xmlDocument2.SelectSingleNode("//ns0:" + strHeaderElement, nsmgr) : null; //xmlDocument2.SelectSingleNode("//ns0:" + this.strHeaderElement, nsmgr);
                ...
                {                   
                    if (!string.IsNullOrEmpty(selectNode.InnerText.Trim()))
                    {
                        stringBuilder.Append(selectNode.OuterXml);
                        var strHeader = xmlNode == null ? string.Empty : xmlNode.OuterXml;
                        xmlDocument2.DocumentElement.InnerXml = strHeader + stringBuilder.ToString();
