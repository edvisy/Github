...
namespace SAP.ANZBank.Replacer.Pipeline
{
    [ComponentCategory(CategoryTypes.CATID_PipelineComponent)]
    [ComponentCategory(CategoryTypes.CATID_Decoder)]
    [System.Runtime.InteropServices.Guid("E6AB3EB5-480E-4e2f-8139-A58B5784F1DA")]
    public class ANZFileReplacer : IBaseComponent, IComponentUI, IComponent, IPersistPropertyBag  
    {
        ...
        {
            get { return "ANZ File Replacer"; }
        }

        public string Name
        {
            get { return "ANZFileReplacer"; }
        }
        ...
        {
            classid = new Guid("CD74CFCC-5FC1-4e2f-A570-G172A77CBF05");
        }
        ...
        public IBaseMessage Execute(IPipelineContext pc, IBaseMessage inmsg)
        {
            try
            {
                ...
                if (srcFileName.Contains("IVR_") == true)
                {
                    fileName = srcFileName.Replace("IVR_",string.Empty);
                }
                else if (srcFileName.Contains("WEBLINK_") == true)
                {
                    fileName = srcFileName.Replace("WEBLINK_", string.Empty);
            ...
            {
                throw new Exception("Error Preprocessing ANZ Bank File Replacer.");
            }
            finally
            {
                //reader.Close();
