...
namespace Visy.Middleware.LGX.DeliveryWare.Orders.ContextPromoter
{

    /// <summary>
    /// Context Promoter pipeline component.
    /// </summary>
    [System.Runtime.InteropServices.Guid("1622990D-8710-438a-ACCD-1F727DD698D2")]
        ...
        Microsoft.BizTalk.Component.Interop.IComponent
    {
        ...
        private IBaseMessage GetNewMessage(IPipelineContext pContext, Stream stream, string filename)
        {
            ...
            if (Visy.Middleware.LGX.DeliveryWare.Orders.Component.OrchestrationHelper.GetCorrlationGuid(filename, true) == "") {
                throw new Exception("Missing GUID");
            }else { 
            // convert string to stream
                byte[] byteArray = Encoding.ASCII.GetBytes("<ns0:Envelop xmlns:ns0=\"http://Visy.Middleware.LGX.DeliveryWare.Orders.Schemas.CorrelationWrapper\"> " +
                    "<ConvoyGuid>" + Visy.Middleware.LGX.DeliveryWare.Orders.Component.OrchestrationHelper.GetCorrlationGuid(filename, true) + "</ConvoyGuid> " +
                ...
                //outMessage.Context.Write("ConvoyGuid", "https://Visy.Middleware.LGX.DeliveryWare.Orders.Schemas.PropertySchema"
                //  , Visy.Middleware.LGX.DeliveryWare.Orders.Component.OrchestrationHelper.GetCorrlationGuid(filename, true));

                //System.Diagnostics.EventLog.WriteEntry("BizTalkApp", "Read: " + outMessage.Context.Read("convoyguid", "https://Visy.Middleware.LGX.DeliveryWare.Orders.Schemas.PropertySchema1").ToString());
