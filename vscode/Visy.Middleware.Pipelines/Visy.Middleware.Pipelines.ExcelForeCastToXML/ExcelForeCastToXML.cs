...
namespace Visy.Middleware.Pipelines.ExcelForeCastToXML
{
    [System.Runtime.InteropServices.Guid("36353bdc-fd2b-449c-ba9b-5a6faa3429c6")]
        ...
        IDisassemblerComponent
    {
        ...
        public string Description
        {
            get
            {
                return "Excel to XML disassembler";
            }
        }
        #endregion
        ...
        public void Disassemble(IPipelineContext pContext, IBaseMessage pInMsg)
        {
            ...
            {
                //Convert to XLSX since Office SDK component accepts only xlsx for newer versions.
            ...
            {
                instream = CopyStream(pInMsg.BodyPart.GetOriginalDataStream());
            }
