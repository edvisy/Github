...
namespace Visy.Middleware.LGX.CUB.PipelineComponents
{
    [System.Runtime.InteropServices.Guid("36353bdc-fd2b-449c-ba9b-5e6faa3429c6")]
    [ComponentCategory(CategoryTypes.CATID_DisassemblingParser)]
    [ComponentCategory(CategoryTypes.CATID_PipelineComponent)]
    public class CUBForeCastDasm : IBaseComponent, IComponentUI, IPersistPropertyBag,
        IDisassemblerComponent
    {
        ...
        public string Description
        {
            get
            {
                return "CUB Excel to XML disassembler";
            }
        }
        #endregion
        ...
        public void Disassemble(IPipelineContext pContext, IBaseMessage pInMsg)
        {
            ...
            #region Change Requirement new Excel Format November 23, 2018
            ...
            var weeks = from b in xdoc.Descendants(rs + "Details")
                        ...
                        into selection
                        orderby selection.WeekName.Substring(3, 4) + selection.WeekName.Substring(0, 2)
                        select selection;
            ...
            XElement outForecastXML = new XElement(outns + "CUBForeCast");
            ...
            foreach (var week in weeks)
            {
                ...
                headerXML.Add(new XElement(outns + "Field" + ch1.ToString(), week.WeekName));
                ch1 = (char)((int)ch1 + 1);
            }
            ...
            strOut.Write(outForecastXML.ToString());
