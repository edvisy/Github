...
app.post("/node/Visy.Middleware.Node/modules/inbound/sap/generic/insert", function (req, res) {
    ...
    var companyCode = {
        data: "//*[local-name()='E2EDK07001GRP']//*[local-name()='PARTN'][1]"
    }
    
    var companyName = {
        data: "//*[local-name()='E2EDK07001GRP']//*[local-name()='NAME1'][1]"
    }
...
app.get("/node/Visy.Middleware.Node/modules/admin/interfacelookup", function (req , res) {
