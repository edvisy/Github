...
app.post("/node/Visy.Middleware.Node/modules/smax/generic/insert", function (req, res) {
    var data = '';
...
app.get("/node/Visy.Middleware.Node/modules/smax", function (req , res) {
    var query = "select * from servicemaxtracking order by created_date desc";
    db.executeQuery(res, query);
});
