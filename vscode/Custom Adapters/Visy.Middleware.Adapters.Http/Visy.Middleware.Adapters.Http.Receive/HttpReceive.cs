...
namespace Visy.Middleware.Adapters.Http.Receive
{
    /// <summary>
...

    {
        ...
        private const string                    protocol                = "HTTP.VISY";
        private const string description = "ASP.NET HTTP Receive Adapter SDK";
