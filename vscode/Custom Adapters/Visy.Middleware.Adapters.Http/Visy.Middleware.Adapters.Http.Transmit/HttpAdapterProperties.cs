...
namespace Visy.Middleware.Adapters.Http.Transmit
{
    ...
    public class HttpAdapterProperties : ConfigProperties
    {
        ...
        private static string protocolAlias = "HTTP.VISY://";
        ...
        private SecurityProtocolType protocolType = 0;
        private string uri;
        ...
        public void LocationConfiguration (XmlDocument configDOM)
        {
            ...
            this.protocolType = ExtractSecurityProtocolType(configDOM);
        }
        ...
        private SecurityProtocolType ExtractSecurityProtocolType(XmlDocument configDOM)
        {
            SecurityProtocolType protocolType = SecurityProtocolType.Tls;

            string hv = IfExistsExtract(configDOM, "/Config/protocolType", "1");

            switch (hv)
            {
                case "0":
                    protocolType = SecurityProtocolType.Tls;
                    break;
                case "1":
                ...
                case "2":
                    ...
                    break;
                case "3":
                    protocolType = SecurityProtocolType.Ssl3;
                    break;
                default:
                    protocolType = SecurityProtocolType.Tls;
                    break;
