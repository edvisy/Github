...
namespace Visy.Middleware.LGX.OrderSPHandler.PipelineComponent
{
                                        ...
                                        IComponent
    {
        ...
        public IBaseMessage Execute(IPipelineContext pContext, IBaseMessage pInMsg)
        {
            ...
            if (bodyPart != null)
            {
                ...
                string poNumber = (string)pInMsg.Context.Read("purchase_order_number", "https://LGX.OrderResponse.Notification.PropertySchema");
                string deliveryAddress = (string)pInMsg.Context.Read("warehouse_code", "https://LGX.OrderResponse.Notification.PropertySchema");
                             
                StringBuilder sb = new StringBuilder();
               
                sb.AppendLine("Visy: BizTalk 2010\r\n");
                sb.AppendLine("PDF Order Error Occurred\r\n");               
