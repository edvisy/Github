...
namespace Visy.Middleware.SAP.BO.MeterDynamics.PipelineComponents
{
        ...
        Microsoft.BizTalk.Component.Interop.IComponent     
    {
        ...
        {
            XNamespace newNs = "http://Visy.Middleware.SAP.BO.MeterDynamics.Schemas.MeterReadings";
            ...
            XmlDocument doc = Newtonsoft.Json.JsonConvert.DeserializeXmlNode("{\"meterreadings\":" + content + "}", "webapi");

            XDocument xdoc = XDocument.Parse(doc.OuterXml);           

            xdoc.Root.Add(new XAttribute(XNamespace.Xmlns + "ns0", newNs));
            xdoc.Root.Name = newNs + "webapi";
