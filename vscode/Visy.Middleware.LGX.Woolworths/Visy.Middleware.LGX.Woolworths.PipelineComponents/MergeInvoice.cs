...
namespace Visy.Middleware.LGX.Woolworths.PipelineComponents
{
        ...
        Microsoft.BizTalk.Component.Interop.IComponent
    {
        ...
        private const string DefaultFileName = "woolworthsinvoice.csv";
        private const string DefaultStagingFolder = "d:\\interfaces\\LGX.Woolworths\\Outbound\\";
        ...
        {
            get { return "LGX.Woolworths.MergeInvoice Component"; }
        }

        public string Name
        {
            get { return "LGX.Woolworths.MergeInvoice.Assembler"; }
        }
        ...
        public IBaseMessage Execute(IPipelineContext pContext, IBaseMessage pInMsg)
        {
            ...
            System.Diagnostics.EventLog.WriteEntry("BizTalkApp", "LGX.Woolworths.PipelineComponents: " + StagingFolder + FileName);
