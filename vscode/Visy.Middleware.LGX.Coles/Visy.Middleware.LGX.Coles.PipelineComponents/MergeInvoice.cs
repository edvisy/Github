...
namespace Visy.Middleware.LGX.Coles.PipelineComponents
{
    /// <summary>
        ...
        Microsoft.BizTalk.Component.Interop.IComponent
    {
        ...
        private const string DefaultFileName = "Colesinvoice.csv";
        private const string DefaultStagingFolder = "d:\\interfaces\\LGX.Coles\\Outbound\\";
        ...
        {
            get { return "LGX.Coles.MergeInvoice Component"; }
        }

        public string Name
        {
            get { return "LGX.Coles.MergeInvoice.Assembler"; }
        }
        ...
        public IBaseMessage Execute(IPipelineContext pContext, IBaseMessage pInMsg)
        {
            ...
            System.Diagnostics.EventLog.WriteEntry("BizTalkApp", "LGX.Coles.PipelineComponents: " + StagingFolder + FileName);
